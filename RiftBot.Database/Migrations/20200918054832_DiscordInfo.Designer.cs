...
namespace RiftBot.Database.Migrations
{
    ...
    [Migration("20200918054832_DiscordInfo")]
    partial class DiscordInfo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RiftBot.Types.Channel", b =>
                {
            ...
            modelBuilder.Entity("RiftBot.Types.DiscordUser", b =>
                {
            ...
            modelBuilder.Entity("RiftBot.Types.Guild", b =>
                {
                    b.Property<decimal>("GuildId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,0)");
            ...
            modelBuilder.Entity("RiftBot.Types.UserGuild", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RiftBot.Types.Channel", b =>
                {
                    b.HasOne("RiftBot.Types.Guild", "Guild")
                        .WithMany()
            ...
            modelBuilder.Entity("RiftBot.Types.UserGuild", b =>
                {
                    b.HasOne("RiftBot.Types.DiscordUser", "DiscordUser")
                        .WithMany()
